...
load('/app-fixed-v8.js?v=15')
.then(()=>load('/final-ui.js?v=15'))
.then(()=>load('/executive-control.js?v=5'))
.then(()=>load('/tasks-v3.js?v=9'))
.then(()=>load('/employee-tasks-empty-fix.js?v=3'))
.then(()=>load('/management-v9.js?v=4'))
.then(()=>load('/map-close-v9.js?v=3'))
.then(()=>load('/final-v10.js?v=3'))
.then(()=>load('/employee-panel-v1.js?v=3'))
.then(()=>load('/final-overrides.js?v=3'))
.then(()=>load('/employee-panel-v4-fix.js?v=5'))
.then(()=>load('/employee-entry-final-fix-v1.js?v=6'))
.then(()=>load('/manager-control-v12.js?v=2'))
.then(()=>load('/manager-control-v12-fix.js?v=2'))
.then(()=>load('/monthly-report-schema-fix.js?v=4'))
.then(()=>load('/employee-control-final-fix.js?v=4'))
